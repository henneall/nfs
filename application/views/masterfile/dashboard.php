            ...
            <div class="container-fluid">
                <div class="row border-class shadow" style="background:white">
                    <div class="col-lg-12">
                        <center>
                            <digiclock id="timer" class="time"><?php echo date("H:i:s A"); ?></digiclock>
                            <h1 style="font-weight:900"><?php echo date("F j, Y") ?></h1>
                        </center>
                    </div>
                </div>
            </div>
