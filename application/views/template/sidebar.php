            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        <li class="nav-item">
                            <a href="<?php echo base_url(); ?>index.php/masterfile/dashboard" class="nav-link dropdown-toggle"><i class="fa big-icon fa-home"></i> <span class="mini-dn">Dashboard</span></a>
                        </li>
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-key"></i> <span class="mini-dn">Masterfile</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="<?php echo base_url(); ?>index.php/masterfile/users_list" class="dropdown-item">Users</a>
                                <a href="<?php echo base_url(); ?>index.php/masterfile/bank_list" class="dropdown-item">Bank</a>
                                <!-- <a href="<?php echo base_url(); ?>index.php/masterfile/insurer_list" class="dropdown-item">Insurer</a> -->
                            </div>
                        </li>
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-plus"></i> <span class="mini-dn">Encode</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="<?php echo base_url(); ?>index.php/encode/brandnew_form" class="dropdown-item">Brand New Form</a>
                                <a href="<?php echo base_url(); ?>index.php/encode/client_data" class="dropdown-item">Clients Data</a>
                            </div>
                        </li>
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-file-text-o"></i> <span class="mini-dn">Reports</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="<?php echo base_url(); ?>index.php/report/brandnew_report" class="dropdown-item">Brand New Report</a>
                                <a href="<?php echo base_url(); ?>index.php/report/client_report" class="dropdown-item">Clients Data Report</a>
                            </div>
                        </li>
